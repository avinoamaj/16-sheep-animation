...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.sheep_vortex).wait(452).to({regX:96.9,regY:22.5,scaleX:1.3436,scaleY:1.3436,x:0.1},0).wait(10).to({_off:true},240).wait(37));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/blackboardbackground.jpg?1597662679102", id:"blackboardbackground"},
		{src:"images/keves_atlas_1.png?1597662678775", id:"keves_atlas_1"},
		{src:"sounds/יונירכטרהכבשהשישהעשרלילהטוב_.mp3?1597662679102", id:"יונירכטרהכבשהשישהעשרלילהטוב"}
	],
	preloads: []
};
